(function () {
  ...
  function applyContentVisibility(p, PV) {
    ...
    if (tagEl) {
      tagEl.classList.toggle("d-none", !tag);
      tagEl.classList.remove("preview-placeholder");
    }
    var hrMain = document.getElementById("hr-main-title");
    if (hrMain) hrMain.classList.toggle("d-none", !fn && !des && !tag);
  ...
  function populate(p) {
    ...
    setText("tagline", p.tagline, "Your tagline");
